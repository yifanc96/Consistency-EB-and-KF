...
s_search=[0.7:0.025:1.3,2.3:0.025:2.7]; ls=length(s_search); %grid search of alpha
sigma_search=0; lsig=length(sigma_search);
tau_search=-2:0.1:2; ltau=length(tau_search);
...
% save data
% save data_matern_MLE_s_tau sol_MLE_s sol_MLE_tau sol_KF_s sol_KF_tau
