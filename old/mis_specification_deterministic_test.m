...
A=spdiags([-v(2:N+1),v(1:N)+v(2:N+1),-v(1:N)],-1:1,N,N)/hg; clear v

v=laplace_mtx(t*hg)'; 
A_lap=spdiags([-v(2:N+1),v(1:N)+v(2:N+1),-v(1:N)],-1:1,N,N)/hg;
...
for iter=1:ln
    ...
    for iter_a=1:la
        for iter_b=1:lb
            ...
            v=kappa(t*hg,a,b)';
            Aab=spdiags([-v(2:N+1),v(1:N)+v(2:N+1),-v(1:N)],-1:1,N,N)/hg;
